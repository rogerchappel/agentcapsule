...
Replace this section with the supported versions for `agentcapsule`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `agentcapsule` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in agentcapsule.
